...
public class JwtTokenUserInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        try {
            ...
            Map map = JwtUtil.parseJWT(jwtProperties.getUserSecretKey(), token);
            log.info("asdas:{}",map.get(JwtClaimsConstant.USER_ID));
            Long userName =Long.valueOf(map.get(JwtClaimsConstant.USER_ID).toString());
            log.info("asdas:{}",userName);
